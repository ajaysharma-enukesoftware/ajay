...
namespace IVPD.Controllers
{
    ...
    public class ScheduleController : ControllerBase
    {
        ...
        [HttpGet("resend_schedule/{id}")]
        public APIResponse ResendSchedule(long ID)
        {
            try
            {
                APIResponse aPIResponse = _scheduleService.ResendSchedule(ID, _appSettings.AdminEmail, _appSettings.SMTPEmail, _appSettings.SMTPPWD, _appSettings.SMTPPort, _appSettings.SMTPServer);
        ...
        [HttpGet("approvedschedule/{id}")]
        public APIResponse ApproveSchedule(long ID)
        {
            try
            {
                APIResponse aPIResponse = _scheduleService.ApprovedSchedule(ID, _appSettings.AdminEmail, _appSettings.SMTPEmail, _appSettings.SMTPPWD, _appSettings.SMTPPort, _appSettings.SMTPServer);
                return new APIResponse(aPIResponse.success, "", aPIResponse.message);
